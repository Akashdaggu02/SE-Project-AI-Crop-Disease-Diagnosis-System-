    ...
    return (
        <View style={[styles.container, { backgroundColor: isDarkMode ? '#2c2c2c' : '#fff' }]}>
            ...
            <View style={styles.progressBarContainer}>
                <View style={[styles.progressBarBg, { backgroundColor: isDarkMode ? '#333' : '#e0e0e0' }]}>
                    <View
                        style={[
                ...
                <Text style={[styles.percentageText, { color: isDarkMode ? '#fff' : '#333' }]}>{severity.toFixed(1)}%</Text>
            </View>
