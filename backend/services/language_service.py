...
UI_LABELS_ENGLISH = {
    ...
    "moderateInfectionMsg": "Moderate infection. Prompt treatment needed to prevent spreading.",
    "severeInfectionMsg": "Severe infection. Immediate action required to save the crop!",
